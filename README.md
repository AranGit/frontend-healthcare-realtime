...
- Typing: Shows exactly which field the patient is currently focusing on (e.g. display pencil icon on the field is editing with typing badge).
- Active: Triggered when the user switches back to the browser tab without focusing on any field.
...
Groups updates: It cancels previous pending sync requests if a new keystroke occurs within 400 ms.
